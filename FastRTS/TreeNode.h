...
public:
	...
	int* childIndexList; 
    /* Take the following form in range
     * [a,b]*[c,d]
	...
	int FindCanonicalNode_Epoch(Query& query,void* quadTree_log,MyVector<int>& nodeIndexList,double err_epo );

	int CanonicalNodeCounter(Query& query,void* quadTree_log, double err_max);
